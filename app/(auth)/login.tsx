        ...
        <KeyboardAvoidingView
          ...
          >
            <View className='items-center gap-3'>
              <Logo />
              <BrandName />
              <Text className='text-gray-500 mt-1 text-sm tracking-wider'>Contirnue Your Journey with DayFlow</Text>
            </View>
            ...
            <View className='gap-8'>
              <View className="flex-row justify-center items-center gap-1">
                ...
                <Link href="/(auth)/register" className='text-rose-500'>Register</Link>
              </View>
